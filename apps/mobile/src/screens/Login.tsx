  ...
  return (
    <ScrollView style={s.screen}>
      <View style={[s.card, { marginTop: 48 }]}>
        ...
        <Text style={s.muted}>Small trusted circles, saving toward one shared goal.</Text>
        <TouchableOpacity
          style={s.btn}
          disabled={!request}
        ...
        <Text style={[s.label, { marginTop: 16 }]}>No Google client IDs configured? Use dev sign-in:</Text>
