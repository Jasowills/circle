...
function makeStyles(t: Palette) {
  return StyleSheet.create({
    ...
    card: { backgroundColor: t.panel, borderColor: t.border, borderWidth: 1, borderRadius: 16, padding: 16, marginBottom: 12 },
    ...
    input: { backgroundColor: t.panel2, borderColor: t.border, borderWidth: 1, color: t.text, borderRadius: 10, padding: 12, fontSize: 15, marginTop: 4 },
    label: { color: t.muted, fontSize: 12, marginTop: 10 },
    btn: { backgroundColor: t.accent, borderRadius: 10, padding: 13, alignItems: 'center', marginTop: 12 },
    btnText: { color: t.accentInk, fontWeight: '700', fontSize: 15 },
    btnGhost: { backgroundColor: 'transparent', borderColor: t.border, borderWidth: 1, borderRadius: 10, padding: 10, alignItems: 'center', marginTop: 12 },
    btnGhostText: { color: t.text, fontWeight: '600' },
    error: { backgroundColor: t.panel2, borderColor: t.text, borderWidth: 1, borderLeftWidth: 4, padding: 10, borderRadius: 8, marginTop: 10 },
    ...
    hero: { height: 400, borderRadius: 16, overflow: 'hidden', marginBottom: 12, backgroundColor: t.panel2 },
    ...
    heroCaption: { position: 'absolute', left: 12, right: 12, bottom: 12, padding: 14, backgroundColor: 'rgba(0,0,0,0.55)', borderRadius: 12 },
