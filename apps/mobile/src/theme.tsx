...
function makeStyles(t: Palette) {
  return StyleSheet.create({
    ...
    card: { backgroundColor: t.panel, borderColor: t.border, borderWidth: 1, borderRadius: 12, padding: 16, marginBottom: 12 },
    ...
    input: { backgroundColor: t.panel2, borderColor: t.border, borderWidth: 1, color: t.text, borderRadius: 8, padding: 12, fontSize: 15, marginTop: 4 },
    ...
    btnGhost: { backgroundColor: 'transparent', borderColor: t.border, borderWidth: 1, borderRadius: 8, padding: 10, alignItems: 'center', marginTop: 12 },
    ...
    hero: { height: 400, borderRadius: 12, overflow: 'hidden', marginBottom: 12, backgroundColor: t.panel2 },
    ...
    heroCaption: { position: 'absolute', left: 12, right: 12, bottom: 12, padding: 14, backgroundColor: 'rgba(0,0,0,0.55)', borderRadius: 8 },
